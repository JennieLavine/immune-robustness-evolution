...
"""
Convert a vector of edges to a binary incidence matrix.
"""
...
function generate_weights_with_max_rowsum(X, max_row_weight)
    n_rows, n_cols = size(X)
    total_weights = max_row_weight * rand(n_rows)
...
function optimize_weights_real_whitacre(
    ...
    for i in 1:n_initial_conditions
        ...
        if return_all
            ...
            push!(w_all, opt_result.minimizer)
