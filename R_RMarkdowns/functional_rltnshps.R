...
curve(1/(9*(x-(11.25/9.225))+1) + 1.125, add=T, lty='dashed')
curve(-0.9*x+1, add=T)
curve(1 - (x^4 / (x^4 +0.1)), add=T, lty='dashed')
legend('bottomleft', lty=1:2, legend=c('non-robust', 'robust'))
...
curve(1.5- (x/(x+0.4)), xlim=c(0,1), ylim=c(0,1.5),
